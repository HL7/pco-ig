...
1. [Measure a PCO Goal using Goal Attainment Scaling (GAS)](#measure-a-pco-goal-using-gas---baseline-visit)
...
<table style="table-layout: fixed ; width:100%">
    ...
    <tbody style="width: 20%">
        <tr>
            <td style="border: 1pt; border-style: solid; padding: 5pt;"> </td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;"> </td>
            <td style="border: 1pt; border-style: solid; padding: 5pt; background-color: #c9daf8;">I practice being present when interacting with family and friends in an uplifting way at least 3x monthly.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;"> </td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;"> </td>
        </tr>
    </tbody>
...
<table style="table-layout: fixed ; width:100%">
    ...
    <tbody style="width: 20%">
        <tr>
            <td style="border: 1pt; border-style: solid; padding: 5pt;"> </td>
            <td style="border: 1pt; border-style: solid; padding: 5pt; background-color: #c9daf8;">I practice being present when interacting with family and friends in an uplifting way 1-2x per month.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;">I practice being present when interacting with family and friends in an uplifting way at least 3x monthly.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;"> </td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;"> </td>
        </tr>
    </tbody>
...
<table style="table-layout: fixed ; width:100%">
    ...
    <tbody style="width: 20%">
        <tr>
            <td style="border: 1pt; border-style: solid; padding: 5pt;"> </td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;">I practice being present when interacting with family and friends in an uplifting way 1-2x per month.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;">I practice being present when interacting with family and friends in an uplifting way at least 3x monthly.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt; background-color: #c9daf8;">I practice being present when interacting with family and friends in an uplifting way at least 4x monthly.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt; background-color: #c9daf8;">I practice being present when interacting with family and friends in an uplifting way at least 5x monthly.</td>
        </tr>
    </tbody>
</table>
...
<table style="table-layout: fixed ; width:100%">
    ...
    <tbody style="width: 20%">
        <tr>
            <td style="border: 1pt; border-style: solid; padding: 5pt; background-color: #c9daf8;">I will not interact with family and friends at all each month.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;">I practice being present when interacting with family and friends in an uplifting way 1-2x per month.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;">I practice being present when interacting with family and friends in an uplifting way at least 3x monthly.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt">I practice being present when interacting with family and friends in an uplifting way at least 4x monthly.</td>
            <td style="border: 1pt; border-style: solid; padding: 5pt;">I practice being present when interacting with family and friends in an uplifting way at least 5x monthly.</td>
        </tr>
    </tbody>
</table>
...
1. Keep the goal and scale as is and follow-up again in a month.   
2. If the goal is no longer relevant or not realistic, they can create a new goal and scale.   
3. Revise the goal to be more realistic for Dorothy to achieve.  
4. Revise the goals in the scale to smaller increments of change or change the timeline for achievement.   
5. The goal and scale can stay the same, but they can adapt the action steps in the care plan to better support Dorothy in achieving her goal. 
...
#### Follow-up on PCO Goal Using a PROM
...
1. Keep the goal as is and follow-up again in a month.   
2. If the goal is no longer relevant or not realistic, they can create a new goal and identify a new PROM to track the goal. .   
3. Revise the goal to be more realistic for Dorothy to achieve.  
...
1. Measure a PCO Goal using Goal Attainment Scaling (GAS)
   * [Person-Centered Goal using GAS](StructureDefinition-pco-gas-goal-profile.html)
   * [GAS progress score](StructureDefinition-pco-gas-score-observation.html)
1. Measure a PCO Goal using Patient-Reported Outcome Measures (PROMs)
   * [Person-Centered Goal using PROM](StructureDefinition-pco-prom-goal-profile.html)
   * [PROM progress score](StructureDefinition-pco-prom-score-observation.html)
